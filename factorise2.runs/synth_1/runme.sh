...
HD_PWD='C:/Users/tim/fpgaprojects/factorise2/factorise2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log factorise.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source factorise.tcl
