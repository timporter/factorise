...
architecture STRUCTURE of dataentry_ram is
  ...
  signal BRAM_PORTA_1_ADDR : STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  BRAM_PORTB_1_ADDR(4 downto 0) <= BRAM_PORTB_addr(4 downto 0);
...
blk_mem_gen_0: component dataentry_ram_blk_mem_gen_0_0
     port map (
      addra(4 downto 0) => BRAM_PORTA_1_ADDR(4 downto 0),
      addrb(4 downto 0) => BRAM_PORTB_1_ADDR(4 downto 0),
