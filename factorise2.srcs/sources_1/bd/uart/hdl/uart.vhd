...
architecture STRUCTURE of uart is
  ...
  end component uart_UART_0_0;
  signal RsRx_1 : STD_LOGIC;
  signal UART_0_RsTx : STD_LOGIC;
  signal UART_0_read_dout : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal UART_0_read_ready : STD_LOGIC;
...
begin
  ...
  clk_1 <= clk;
  read_ack_1 <= read_ack;
  read_dout(7 downto 0) <= UART_0_read_dout(7 downto 0);
  read_ready <= UART_0_read_ready;
  send_delay_1 <= send_delay;
  send_din_1(7 downto 0) <= send_din(7 downto 0);
  send_ready_1 <= send_ready;
UART_0: component uart_UART_0_0
     port map (
      RsRx => RsRx_1,
      RsTx => UART_0_RsTx,
      clk => clk_1,
