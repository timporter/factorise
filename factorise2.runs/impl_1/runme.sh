...
HD_PWD='C:/Users/tim/fpgaprojects/factorise2/factorise2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log factorise.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source factorise.tcl -notrace
