...
HD_PWD='C:/Users/tim/fpgaprojects/factorise2/factorise2.runs/stringsrom_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stringsrom_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stringsrom_blk_mem_gen_0_0.tcl
